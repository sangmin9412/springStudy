...
public class MailService {
	...
	public void sendMail(String reciver, String userId) throws Exception {
		...
		String content = "<html><body>"
				       ...
				       + "<a href='http://172.16.3.20:8080/SpringMybatisMVCProject/"
				       + "register/memberMail?num="+num+"&reciver="+reciver+"&userId="+userId+"'>"
				       + "<strong><b>"
