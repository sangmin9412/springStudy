...
<body>
<div><a href="/cart/goodsCartList" >장바구니 가기</a></div>
<div><a href="/cart/goodsWishList" >관심상품 가기</a></div>
...
<c:forEach items="${list }" var="dto" varStatus="cnt">
	<tr><td  width=10% >
			<a href="goodsDetail/${dto.goodsNum }">
			${dto.goodsNum }</a>
		</td>
	    <td  width=40%>
	    	<c:forTokens items="${dto.goodsImage }" delims="`" var="image" begin="0" end="0">
	    		<img width="50" src="/goodsView/upload/${ image }" />
	    	</c:forTokens>
	    </td>
