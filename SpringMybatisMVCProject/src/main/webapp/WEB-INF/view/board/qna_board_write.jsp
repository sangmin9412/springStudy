...
<body>
<form:form action="boardWritePro" method="post" name="frm" commandName="boardCommand" >
<table cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td>
			<form:input path="boardName" size="10" maxlength="10" value="" />
	...
	<tr>
		...
		<td>
			<form:input path="boardSubject" type="text" size="50" maxlength="100" 
				value=""/>
